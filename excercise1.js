 ...
 */
    ...
    function isArithmeticProgression(numbers) {
        // Jika array memiliki kurang dari 2 elemen, tidak mungkin menjadi deret aritmatika
        if (numbers.length < 2) return false;
    
        // Menghitung selisih antara dua elemen pertama
        const diff = numbers[1] - numbers[0];
    
        // Memeriksa selisih antara setiap pasangan elemen berurutan
