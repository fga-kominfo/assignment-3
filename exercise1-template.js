...
function isArithmeticProgression(numbers) {
    // your code here
    // Hitung selisih antara elemen kedua dan pertama
  let diff = numbers[1] - numbers[0];

  // Mulai loop dari indeks ke-1 untuk membandingkan setiap elemen dengan elemen sebelumnya
  for (let i = 1; i < numbers.length - 1; i++) {
    // Jika selisih antara elemen saat ini dan sebelumnya tidak sama dengan selisih awal
